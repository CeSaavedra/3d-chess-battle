...
# Finished
- Functional account log-in
- Functional account page

## TO-DO
- Functional account registration
- Allow account data updates
- Allow pages to recognize which account is logged-in
- Connect front-end to MySQL server
- Front-end Host (Vercel or Heroku)
...
bash
Install Express and Socket.IO (if not already)
npm install express socket.io

Create public and copy the top-level index.html into it
mkdir -p public
cp index.html public/

Create symlinks inside public that point to the src subfolders
